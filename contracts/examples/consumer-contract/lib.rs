...
mod example_consumer {
	...
	impl ExampleConsumer {
		...
		/// # Errors
		///
		/// - [`ContractError::Unauthorized`] - Only the contract owner can request subscription information
	...
	impl IdnConsumer for ExampleConsumer {
		...
		/// # Arguments
		///
		/// * `quote` - The Quote containing 	request_reference of the message, the calculated fees, and the required deposit for a subscription.
		///
		/// # Returns
		///

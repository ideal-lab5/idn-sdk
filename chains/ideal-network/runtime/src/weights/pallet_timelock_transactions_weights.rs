...
impl<T: frame_system::Config> pallet_timelock_transactions::WeightInfo for WeightInfo<T> {
	...
	fn schedule_sealed(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_500_000, 0)
			...
			// Standard Error: 28_315
			.saturating_add(Weight::from_parts(9_182_781, 0).saturating_mul(s.into()))
	...
	fn service_agenda(s: u32, ) -> Weight {
		...
		Weight::from_parts(6_000_000, 0)
			...
			.saturating_add(Weight::from_parts(6_726_135, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(10_500_000, 0)
			...
			// Standard Error: 252
			.saturating_add(Weight::from_parts(21_535, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))

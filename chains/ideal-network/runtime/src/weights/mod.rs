...
pub mod pallet_contracts_weights;
pub mod pallet_idn_manager_weights;
pub mod pallet_message_queue_weights;
pub mod pallet_randomness_beacon_weights;
...
pub use pallet_contracts_weights::WeightInfo as ContractsWeightInfo;
pub use pallet_idn_manager_weights::WeightInfo as IdnManagerWeightInfo;
pub use pallet_message_queue_weights::WeightInfo as MessageQueueWeightInfo;
pub use pallet_randomness_beacon_weights::WeightInfo as RandomnessBeaconWeightInfo;

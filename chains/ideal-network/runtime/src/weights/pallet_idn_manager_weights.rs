...
impl<T: frame_system::Config> pallet_idn_manager::WeightInfo for WeightInfo<T> {
	...
	fn update_subscription(_m: u32, ) -> Weight {
		...
		Weight::from_parts(54_373_622, 0)
			.saturating_add(Weight::from_parts(0, 4225))
	...
	/// Storage: `IdnManager::Subscriptions` (r:5001 w:5000)
	/// Proof: `IdnManager::Subscriptions` (`max_values`: None, `max_size`: Some(760), added: 3235, mode: `MaxEncodedLen`)
	...
	fn dispatch_pulse(s: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `554 + s * (157 ±0)`
		//  Estimated: `4225 + s * (3235 ±0)`
		// Minimum execution time: 82_000_000 picoseconds.
		Weight::from_parts(4_276_323_896, 0)
			.saturating_add(Weight::from_parts(0, 4225))
			// Standard Error: 708_267
			.saturating_add(Weight::from_parts(48_683_405, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn on_finalize(s: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `495 + s * (157 ±0)`
		//  Estimated: `4225 + s * (3235 ±0)`
		// Minimum execution time: 48_000_000 picoseconds.
		Weight::from_parts(49_000_000, 0)
			.saturating_add(Weight::from_parts(0, 4225))
			// Standard Error: 313_948
			.saturating_add(Weight::from_parts(43_335_819, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(s.into())))
			.saturating_add(T::DbWeight::get().writes(2))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(s.into())))

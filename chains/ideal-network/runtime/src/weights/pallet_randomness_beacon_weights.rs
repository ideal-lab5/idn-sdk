...
impl<T: frame_system::Config> pallet_randomness_beacon::WeightInfo for WeightInfo<T> {
	...
	fn try_submit_asig(r: u32, ) -> Weight {
		...
		//  Measured:  `206`
		//  Estimated: `4225`
		// Minimum execution time: 8_514_000_000 picoseconds.
		Weight::from_parts(7_779_180_969, 0)
			.saturating_add(Weight::from_parts(0, 4225))
			// Standard Error: 24_673_929
			.saturating_add(Weight::from_parts(1_388_870_108, 0).saturating_mul(r.into()))

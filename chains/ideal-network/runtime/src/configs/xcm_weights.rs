...
use crate::{configs::xcm_config::MaxAssetsIntoHolding, weights, Runtime};
...
pub struct IdnXcmWeight<Call>(core::marker::PhantomData<Call>);
impl<Call> XcmWeightInfo<Call> for IdnXcmWeight<Call> {

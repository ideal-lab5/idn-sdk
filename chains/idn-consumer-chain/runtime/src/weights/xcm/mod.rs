...
use crate::{configs::xcm_config::MaxAssetsIntoHolding, Runtime};
use alloc::vec::Vec;
...
pub struct IdnConsumerPolkadotXcmWeight<Call>(core::marker::PhantomData<Call>);
impl<Call> XcmWeightInfo<Call> for IdnConsumerPolkadotXcmWeight<Call> {

...
// --output=./chains/idn-consumer-chain/runtime/src/weights/pallet_transaction_payment_weights.rs
...
impl<T: frame_system::Config> pallet_transaction_payment::WeightInfo for WeightInfo<T> {
	...
	fn charge_transaction_payment() -> Weight {
		...
		//  Measured:  `101`
		//  Estimated: `3593`
		// Minimum execution time: 63_800_000 picoseconds.
		Weight::from_parts(64_724_000, 0)

...
use sc_consensus::{
	...
	BlockImport, BlockImportParams, DefaultImportQueue, ForkChoiceStrategy,
};
	...
	CIDP: CreateInherentDataProviders<Block, ()> + 'static,
{
	...
	let verifier: Verifier::<P, _, _, _> = Verifier::new(client, create_inherent_data_providers, telemetry);

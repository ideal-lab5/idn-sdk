...
use drand_example_runtime::{Block, EXISTENTIAL_DEPOSIT};
				...
				match config.network.network_backend {
					sc_network::config::NetworkBackendType::Libp2p => service::new_full::<
						sc_network::NetworkWorker<
							drand_example_runtime::opaque::Block,
							<drand_example_runtime::opaque::Block as sp_runtime::traits::Block>::Hash,
						>,
					>(config)

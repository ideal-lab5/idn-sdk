...
///   release balances.
/// * `F`: The frequency type (typically `u32` or `u64`).
/// * `P`: The pulse/lifetime type (typically `u32` or `u64`).
pub struct FeesManagerImpl<Treasury, Sub, Balances, F = u32, P = u32> {
	_phantom: PhantomData<(Treasury, Sub, Balances, F, P)>,
}
...
impl<Treasury, Sub, Balances, Frequency, Lifetime>
	FeesManager<
		Balances::Balance,
		u64,
		Frequency,
	...
	> for FeesManagerImpl<Treasury, Sub, Balances, Frequency, Lifetime>
where
	...
	Frequency: sp_runtime::Saturating,
	Lifetime: sp_runtime::Saturating,
	u64: From<Frequency> + From<Lifetime>,
{

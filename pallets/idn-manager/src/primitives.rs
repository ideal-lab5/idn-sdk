...
#[derive(Encode, Decode, Clone, TypeInfo, MaxEncodedLen, Debug, PartialEq, Default)]
...
pub enum IdnManagerCall<CreateSubParams, UpdateSubParams, SubId> {
	...
	#[codec(index = 1)]
	pause_subscription { sub_id: SubId },
	/// `pallet-idn-manager::Call::kill_subscription`
	#[codec(index = 2)]
	kill_subscription { sub_id: SubId },
	...
	#[codec(index = 4)]
	reactivate_subscription { sub_id: SubId },
}
